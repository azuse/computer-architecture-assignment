...
#
# Generated by Vivado on Tue Apr 24 16:51:33 +0800 2018
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L xpm -L unisims_ver -L unimacro_ver -L secureip --snapshot DMEM xil_defaultlib.DMEM xil_defaultlib.glbl -log elaborate.log
}

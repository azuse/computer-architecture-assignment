...
add wave -noupdate /sccomp_dataflow_oj_tb/clk_div
...
add wave -noupdate /sccomp_dataflow_oj_tb/instPrev
add wave -noupdate /sccomp_dataflow_oj_tb/pcPrev
add wave -noupdate /sccomp_dataflow_oj_tb/cpuRunning
add wave -noupdate /sccomp_dataflow_oj_tb/file_output
add wave -noupdate /sccomp_dataflow_oj_tb/cpuEna_n
add wave -noupdate /sccomp_dataflow_oj_tb/cpuDonotRecordFirst
...
add wave -noupdate /sccomp_dataflow_oj_tb/addr
add wave -noupdate /glbl/GSR
add wave -noupdate /sccomp_dataflow_oj_tb/uut/sccpu/iLhu
add wave -noupdate /sccomp_dataflow_oj_tb/uut/sccpu/iLh
add wave -noupdate /sccomp_dataflow_oj_tb/uut/sccpu/bytePos
add wave -noupdate /sccomp_dataflow_oj_tb/cpuRunning
add wave -noupdate /sccomp_dataflow_oj_tb/uut/sccpu/startCounter
add wave -noupdate /sccomp_dataflow_oj_tb/uut/sccpu/cpu_ref/array_reg
...
add wave -noupdate /sccomp_dataflow_oj_tb/uut/sccpu/lo
...
add wave -noupdate /sccomp_dataflow_oj_tb/uut/imemAddr
add wave -noupdate /sccomp_dataflow_oj_tb/uut/imemIn
add wave -noupdate /sccomp_dataflow_oj_tb/uut/imemOut
add wave -noupdate /sccomp_dataflow_oj_tb/uut/imemRealAddr
add wave -noupdate /sccomp_dataflow_oj_tb/uut/imemWe
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {2864795 ps} 0}
...
update
WaveRestoreZoom {2825991 ps} {2903599 ps}
